    ...
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            @auth
                ...
                <flux:navbar.item icon="qr-code" :href="route('signature.index')"
                    :current="request()->routeIs('signature*')" wire:navigate>
                    Signature
                </flux:navbar.item>
            @endauth
        </flux:navbar>
        ...
        <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
            <flux:tooltip hidden :content="__('Search')" position="bottom">
    ...
    <flux:sidebar stashable sticky
        ...
        <flux:navlist variant="outline">
            @auth
                ...
                <flux:navlist.item icon="qr-code" :href="route('signature.index')"
                    :current="request()->routeIs('signature*')" wire:navigate>
                    Signature
                </flux:navlist.item>
            @endauth
